...
function site_scripts() {
  global $wp_styles; // Call global $wp_styles variable to add conditional wrapper around ie stylesheet the WordPress way
    ...
    wp_enqueue_style( 'go-css', get_template_directory_uri() . '/assets/css/go-style.css', array(), '', 'all' );
    ...
    wp_enqueue_style( 'google-fonts', '//fonts.googleapis.com/css?family=Open+Sans', false );

    if(is_page('Home')){
      wp_enqueue_script( 'typed-js', get_template_directory_uri() . '/assets/js/typed.js', array( 'jquery' ), '', false );
    }
